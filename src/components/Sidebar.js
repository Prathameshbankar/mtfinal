            ...
            {sidebarBlocks[key].map((block, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-row items-center ${bgColor} ${textColor} px-3 py-2 my-1 text-sm cursor-pointer rounded-md transition duration-300 ease-in-out hover:shadow-md hover:bg-opacity-90`}
                >
                  {block.text}
                </div>
              );
