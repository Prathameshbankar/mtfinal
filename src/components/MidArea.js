            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                {selectedSprite.actions.map((action, index) => (
                  <li key={index} className="flex justify-between items-center bg-blue-100 text-blue-800 px-4 py-2 rounded-lg shadow-sm transition duration-300 ease-in-out hover:shadow-md hover:bg-blue-200">
